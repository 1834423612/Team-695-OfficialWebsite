<template>
  <footer class="mt-0 bg-gray-900 py-8 text-white">
    <div class="container mx-auto px-4">
      <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
        ...
        <div>
          ...
          <ul class="space-y-2">
            ...
            <li>
              <a href="https://doc.team695.com/" class="text-gray-400 hover:text-white">Team Documentation</a>
            </li>
            <li>
        ...
        <div>
          ...
          <div class="flex space-x-4">
            ...
            <a href="https://www.instagram.com/beachwood695/" target="_blank" class="text-gray-400 hover:text-white">
      ...
      <div class="mt-8 border-t border-gray-700 pt-8 text-center">
        <span class="text-gray-400">Made with ❤️ by &nbsp;</span>
        <mark class="text-white text-md md:whitespace-nowrap inline-block md:inline font-semibold 
                pl-2 pr-3 my-1 md:my-0 shadow-lg highlight">
...
<style scoped>
.highlight {
  /* Use the highlight class to style the mark element */
  ...
  border-radius: 4px;
  /* Add shadow */
  box-shadow: 0 0 5px rgba(255, 233, 0, 0.5);
}
</style>