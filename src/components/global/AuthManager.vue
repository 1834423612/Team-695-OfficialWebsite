...
export default defineComponent({
  ...
  setup() {
     ...
     * 处理认证无效事件
     */
    const handleAuthInvalid = async (event: CustomEvent) => {
      console.warn('AuthManager: Auth invalid event detected:', event.detail);
      await handleAuthFailure(event.detail?.message);
    };
